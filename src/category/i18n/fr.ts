...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    {
      type: 'title',
      text: 'Outils professionnels pour les créateurs de contenu vertical',
      level: 2,
    },
    {
      type: 'paragraph',
      html: "Le contenu vertical a révolutionné la consommation numérique. TikTok, Instagram Reels et YouTube Shorts se disputent les mêmes secondes d'attention et chaque pixel compte. Cette collection d'utilitaires est née du besoin d'optimiser et de vérifier le contenu avant de le publier, garantissant que chaque création apparaît exactement comme prévu.",
    },
    {
      type: 'paragraph',
