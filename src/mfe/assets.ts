...
const UTILITY_ASSET_ROOT = "/_utilities/social";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/social/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/social/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("social");
